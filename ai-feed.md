...
{% assign reading_sources = "Hugging Face Blog,Hugging Face Papers,arXiv (cs.AI),OpenAI,Anthropic,Google DeepMind,The Batch,Simon Willison,Ahead of AI,One Useful Thing,antirez,Andrej Karpathy" | split: "," %}
